...
from wasteman.models import Waste, Schedule, IssueReport, WasteType, PickupZone
    ...
    if request.method == 'POST':
        ...
        try:
            with transaction.atomic():
                ...
                waste = Waste.objects.create(schedule=waste_schedule, quantity=quantity, user=user, type=waste_type)
            ...
            messages.error(request, 'An error occurred while creating a waste entry: Unique constraint violated')
